...
<li class="dropdown" style="float: left; color:white;"><a href="#" class="dropbtn">Categories&emsp;</a>
   <div class="dropdown-content">

    <a href="web.php">Web Development</a>
      <a href="android.php">Android Development</a>
      <a href="comp.php">Computer Technology</a>
