   ...
   <div class="dropdown-content">
    ...
    <a href="category/web.php">Web Development</a>
      ...
      <a href="category/comp.php">Computer Technology</a>
       <a href="category/others.php">Other Technology</a>
...
<img height="382px" width="100%" src="images/back.jpeg">
<br><br>
...
<p style="font-family:normal; font-size:25px;"><i>Technology has played a role in exploring and understanding the ocean for thousands of years, and it will continue to do so. Here on this website, you get the help from your peers with related topic of yours.</i></p>
</div>
...
<center>
<div style="background-color:#7FF40C;">
<p  style="color:White; font-size:300%; font-family:verdana; background-color:#7FF40C;">Latest Posts</p></div>
...
while($row = mysqli_fetch_array($query))
{
 ...
 // echo "<p>$topic</p><br>";
  echo "<br><p ><a href='topic.php?posts_topic=$id'  style='text-decoration:none; color:black; font-size:32px; font-weight:bold; margin-left: 20px; '>&nbsp&nbsp&nbsp
   ".$topic." </a></p><br><br><p style='color:black; font-size:25px; font-weight:bold; margin-left: 50px;'>In</p><p style='text-decoration:none; color:blue; font-size:25px; font-weight:bold; margin-left: 0px; '> $cat</p><br><br><br><hr style='color:#7ff40c;'>";
}
...
<div style="background-color:#7ff40c">
<p  style="color:White; font-size:300%; font-family:verdana; background-color:#7ff40c;width:100%;text-align:center">User's Feedback</p>
</div>
</div>
...
<div class="xx">
<h3>Contact Us:</h3>
<p style="font-size: 20px">Developed by<br>Anshul<br></p>
</div>
...
<p align="center" style="text-align:center; float:center; margin-left:500px; font-size: 20px; font-weight:bold; color:white;">.</p>
